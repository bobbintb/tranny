...
(function() {
  var STATUS_CLIENT_NOT_AVAILABLE, STATUS_FAIL, STATUS_INCOMPLETE_REQUEST, STATUS_INTERNAL_ERROR, STATUS_INVALID_INFO_HASH, STATUS_OK, action_reannounce, action_recheck, action_remove, action_remove_data, action_start, action_stop, action_torrent_details, action_torrent_peers, action_torrent_speed, bytes_to_size, chart_update, client_chart, detail_elements, detail_traffic_chart, detail_update_speed, detail_update_timer, endpoint, error_handler, fmt_duration, fmt_timestamp, graph_fps, graph_type, graph_window_size, handle_event_alert, handle_event_speed_overall_response, handle_event_torrent_details_response, handle_event_torrent_files_response, handle_event_torrent_list_response, handle_event_torrent_peers_response, handle_event_torrent_reannounce_response, handle_event_torrent_recheck_response, handle_event_torrent_remove_response, handle_event_torrent_speed_response, handle_event_torrent_stop_response, has_connected, in_url, overall_speed_update, overall_speed_update_timer, peer_chart, peer_update_timer, queue_size, render_peers, row_load_handler, row_remove, row_select_handler, selected_class, selected_detail_id, selected_rows, show_alert, socket, special_alerts, speed_dn, speed_up, speed_update_timer, template, torrent_table, ts, update_speed, user_messages, _alert_num, _sizes;
